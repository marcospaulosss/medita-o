...
// in cinco_minutos_meditacao/test/modules/authentication/login/login_view_integration_test.dart.
...
class MockLoginPresenter extends _i1.Mock implements _i2.LoginPresenter {
  ...
  @override
  set view(_i3.LoginViewContract? _view) => super.noSuchMethod(
        Invocation.setter(
          #view,
          _view,
        ),
  ...
  @override
  _i4.Future<void> loginGoogle() => (super.noSuchMethod(
        Invocation.method(
          #loginGoogle,
          [],
        ),
  ...
  @override
  _i4.Future<void> goToForgotPassword() => (super.noSuchMethod(
        Invocation.method(
          #goToForgotPassword,
          [],
        ),
