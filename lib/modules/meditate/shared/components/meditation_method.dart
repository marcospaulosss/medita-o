import 'package:cinco_minutos_meditacao/modules/meditate/screens/in_your_time/components/combo_box.dart';
import 'package:cinco_minutos_meditacao/shared/Theme/app_colors.dart';
import 'package:cinco_minutos_meditacao/shared/components/icon_label_button.dart';
import 'package:flutter/material.dart';

/// Tipos de botão
enum MeditationMethodButtonType { blue, white, combo }
...
class MeditationMethod extends StatelessWidget {
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            if (iconButton1 != null) getButton(iconButton1),
            const SizedBox(height: 11),
            if (iconButton2 != null) getButton(iconButton2),
          ],
        ),
      ),
    );
  ...
  Widget getButton(MeditationMethodButtonCustom? button) {
    switch (button!.type) {
      case MeditationMethodButtonType.blue:
        return buildIconLabelButtonDefault1(
          button.onTap,
          button.label,
          button.icon,
        );
      case MeditationMethodButtonType.white:
        return buildIconLabelButtonDefault2(
          button.onTap,
          button.label,
          button.icon,
        );
